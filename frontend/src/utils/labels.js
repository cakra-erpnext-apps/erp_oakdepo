...
export const labels = {
	...
	// Foto profil (avatar in the Profil hero)
	profilePhotoChange: "Ganti foto profil",
	profilePhotoRemove: "Hapus foto",
	profilePhotoSaved: "Foto profil diperbarui",
	profilePhotoRemoved: "Foto profil dihapus",
	profilePhotoFailed: "Foto gagal disimpan. Pakai JPG/PNG/WEBP, maks 8 MB.",
	...
	// FOO / CHM — peruntukan tank. Kosong berarti belum ditetapkan, bukan "bukan foodgrade".
	...
	leakManual: "Manual",
	listUrgentGroup: "Mendesak",
	listNoDueGroup: "Tanpa target tanggal",
	listSortPriority: "Prioritas",
	monitorWork: "Proses",
	monitorLast: "Terakhir",
	mrListSearch: "Cari no. tank, Reff Doc, no. order…",
	mrListEmpty: "Tidak ada order yang cocok.",
	mrContinue: "Lanjutkan pekerjaan",
	mrFoldedGroup: "Ditolak / dibatalkan",
	listStatReview: "Review",
	cleaningViewRecord: "Lihat catatan lengkap",
	gateDirection: "Arah",
	...
	eirCount: "{n} EIR",
	eirListEmpty: "Tidak ada EIR di daftar ini.",
	...
	leakDetailTitle: "Leak Check",
	leakCreated: "Order dibuat",
	leakChecked: "Dicek",
	leakCheckedBy: "Dicek oleh",
	leakPhotoCount: "{n} foto",
	leakNoRemarks: "Tidak ada remark.",
	...
	tankPosFilterHistory: "Riwayat",
	tankPosOrdersHint: "Tank yang surveinya sudah dijadwalkan tapi posisinya belum dicatat — atau catatannya lebih tua dari booking-nya. Catat posisinya dan tank keluar dari daftar ini sendiri.",
	tankPosOrdersEmpty: "Semua tank yang menunggu survey sudah ada posisinya.",
	tankPosHistoryEmpty: "Belum ada pencatatan posisi.",
	tankPosUnlocated: "Posisi belum terdata",
	tankPosUnlocatedHint: "Tank ini belum pernah dicatat posisinya.",
	tankPosCurrent: "Posisi sekarang",
	tankPosUpdate: "Perbarui posisi",
	tankPosInput: "Isi posisi",
	tankPosSave: "Simpan",
	tankPosSaved: "Posisi tersimpan",
	tankPosNewLabel: "Posisi baru",
	tankPosNote: "Catatan (opsional)",
	tankPosNoteHint: "mis. dipindah karena bay dipakai truk",
	tankPosHistory: "Riwayat posisi",
	// Foto posisi — bukan bukti kerja, tapi patokan visual. Kalimat "blok kanan tumpukan 2"
	...
	tankPosPhotos: "Foto posisi",
	tankPosPhotoHint: "Foto tumpukan atau bay biar gampang dicari orang berikutnya.",
	tankPosPhotoEmpty: "Belum ada foto",
	tankPosPhotoCount: "foto",
	tankPosStale: "Perlu dicek ulang",
	tankPosFresh: "Baru diperbarui",
	tankPosBy: "oleh",
	// --- Posisi Tank: redesain 2026-09-10 -------------------------------------
	// Papan pembuka: empat angka + tiga daftar pendek.
	tankPosDicatat: "Dicatat",
	tankPosSortStale: "urut: paling basi dulu",
	tankPosStatAll: "Semua",
	tankPosStatLocated: "Terdata",
	tankPosStatMissing: "Belum",
	tankPosStatRecheck: "Perlu dicek",
	tankPosSecRecheck: "Perlu dicek ulang",
	tankPosSecRecheckHint: "posisi > {n} hari",
	tankPosSecMissing: "Belum terdata",
	tankPosSecToday: "Terdata hari ini",
	...
	tankPosTemplateFree: "Ketik bebas kalau posisinya di luar template.",
	tankPosTemplateSaveAs: "+ Simpan “{label}”",
	tankPosManageTemplates: "Kelola template",
	tankPosOptional: "opsional",
	tankPosPhotoOne: "1 cukup",
	tankPosAutoStamp: "Waktu dan nama pencatat disimpan otomatis",
	tankPosSaveWith: "Simpan · {label}",
	// Sukses.
	...
	tplSharedTitle: "Dipakai bersama satu depot",
	tplSharedHint: "Semua petugas {depot} lihat daftar yang sama. Urutan atas muncul duluan di form.",
	tplAdd: "Tambah template",
	tplAddPlaceholder: "mis. B5-R1 atau Bay 3",
	tplAddBtn: "Tambah",
	tplList: "Daftar template",
	tplReorderHint: "panah untuk urutkan",
	tplUsed: "dipakai {n}×",
	tplLastUsed: "terakhir {t}",
	tplNeverUsed: "belum pernah dipakai",
	tplEmpty: "Belum ada template. Tambahkan posisi yang paling sering dipakai di depo ini.",
	tplSuggestTitle: "Sering diketik manual",
	tplSuggestNote: "belum jadi template",
	tplSuggestTyped: "diketik {n}× minggu ini",
	tplSuggestMake: "+ Jadikan",
	tplRename: "Ganti nama",
	tplDelete: "Hapus template",
	tplDeleteAsk: "Hapus template “{label}”?",
	// Kalimat ini yang membuat dialognya berguna: yang ditakutkan orang sebelum menghapus
	// adalah kehilangan data, dan yang hilang di sini cuma daftar pilihannya.
	tplDeleteBody: "Template hilang dari form untuk semua petugas {depot}. Posisi tank yang sudah tercatat sebagai “{label}” tidak ikut berubah.",
	tplDeleteInUse: "Sedang dipakai",
	tplDeleteTanks: "{n} tank",
	tplBackToForm: "Kembali ke form",
	tplMoveUp: "Naikkan urutan",
	tplMoveDown: "Turunkan urutan",
	tplCancel: "Batal",
	// --- Catat sekaligus ------------------------------------------------------
	bulkTitle: "Catat sekaligus",
	bulkOpen: "Catat sekaligus",
	bulkIntroTitle: "Satu posisi untuk beberapa tank",
	bulkIntroHint: "Pilih tank, lalu simpan sekali.",
	bulkTarget: "Posisi tujuan",
	bulkTargetAll: "berlaku untuk semua",
	bulkPicked: "Tank dipilih",
	bulkAdd: "Tambah tank",
	bulkPickHint: "Cari nomor tank untuk menambahkan.",
	bulkPrevNone: "sebelumnya belum terdata",
	bulkPrev: "sebelumnya {label}",
	bulkPhotoAll: "1 foto untuk semua",
	bulkSave: "Simpan {n} tank ke {label}",
	bulkSaveHint: "Semuanya dicatat dengan posisi yang sama.",
	bulkEmpty: "Belum ada tank yang dipilih.",
	bulkPartial: "{n} tank gagal disimpan",
	bulkTankWord: "tank",
	// --- Riwayat posisi satu tank --------------------------------------------
	posHistTitle: "Riwayat posisi",
	posHistMoves: "Perpindahan",
	posHistLast: "{n} terakhir",
	posHistMoveCount: "Pindah",
	posHistTimes: "{n} kali",
	posHistInDepot: "Di depo",
	posHistPhotos: "{n} foto",
	posHistUpdate: "Perbarui posisi",
	...
	// --- Lowering & Survey: redesain 2026-09-10 (satu alur) --------------------
	lowTitle: "Lowering tank",
	lowHint: "Tank booking out yang masih di atas",
	lowSearch: "Cari no. tank atau no. jadwal",
	lowStatAll: "Semua",
	lowStatUrgent: "Mendesak",
	lowStatWaiting: "Menunggu",
	lowStatLowered: "Lowered",
	lowSecUrgent: "Mendesak",
	// Disebut lengkap karena "Mendesak" di app ini punya DUA sumber: dinyatakan orang yang
	// berwenang (target_urgent_on), atau tenggatnya memang tinggal beberapa hari.
	lowSecUrgentHint: "mendesak atau ≤ {n} hari",
	lowSecWaiting: "Menunggu lowering",
	lowSecToday: "Lowered hari ini",
	lowMark: "Tandai",
	lowMarkMany: "Tandai {n} sekaligus",
	lowEmpty: "Tidak ada tank menunggu lowering",
	lowEmptyHint: "Tank muncul di sini saat jadwal survey tank out dibuat.",
	lowEmptyCta: "Lihat jadwal survey",
	lowPickup: "pickup",
	// Tandai sekaligus.
	bulkLowTitle: "Tandai lowered",
	bulkLowIntro: "Beberapa tank sekaligus",
	bulkLowIntroHint: "Biasanya diturunkan berbarengan dari satu jadwal.",
	bulkLowPicked: "Tank dipilih",
	bulkLowNoteAll: "berlaku untuk semua",
	bulkLowSave: "Tandai {n} tank lowered",
	bulkLowHint: "Masing-masing dicatat terpisah di riwayatnya.",
	bulkLowDone: "{n} tank ditandai lowered",
	bulkLowDoneHint: "Surveyor mendapat notifikasi; survey bisa dikerjakan.",
	bulkLowBack: "Kembali ke daftar",
	bulkLowOpenSurvey: "Buka survey",
	bulkLowPartial: "{n} tank gagal ditandai",
	bulkLowNeedPos: "{n} tank belum ada posisinya",
	bulkLowNeedPosHint: "Tank tanpa posisi tidak bisa ditandai lowered — surveyornya tidak punya tempat untuk berjalan. Buka satu per satu dan isi posisinya sekalian.",
	// Detail tank — dua langkah dalam satu layar.
	stepLowering: "Lowering",
	stepSurvey: "Survey",
	tankNotDownTitle: "Belum diturunkan ke ground level",
	tankNotDownBody: "Tandai lowered dulu sebelum survey bisa dikerjakan.",
	tankUrgentTitle: "Pickup {t}, belum diturunkan",
	tankUrgentBody: "Tandai lowered dulu supaya surveyor bisa mengerjakan survey.",
	tankReadyTitle: "Sudah di ground level, siap disurvey",
	tankReadyBody: "Lowering selesai {t}",
	tankMarkLowered: "Tandai lowered",
	tankLoweringNote: "Catatan lowering",
	...
	tankFinishSurvey: "Selesai survey",
	tankFinishHint: "Menutup survey otomatis menerbitkan draft EIR-Out untuk tank ini",
	...
	tankUndo: "Batalkan",
	tankUndoPick: "Pilih",
	// Kalimat tiap kejadian di riwayat. Dirakit dari stempel di baris tank-nya sendiri.
	evScheduled: "Jadwal survey dibuat",
	evScheduledFrom: "dari {ref}",
	evLowered: "Ditandai lowered",
	evSurveyed: "Disurvey",
	evEirOut: "Draft EIR-Out terbit",
	evReopened: "Dibuka lagi",
	// --- Daftar jadwal survey -------------------------------------------------
	svListTitle: "Survey order",
	...
	svSecUrgentHint: "H-{n} atau kurang",
	svChipDate: "Tanggal",
	svChipPrincipal: "Prinsipal",
	svChipDepot: "Depo",
	svClearAll: "Hapus filter",
	svChipActive: "Aktif saja",
	svChipSort: "Urut",
	svSortDue: "Tenggat terdekat",
	svSortNewest: "Terbaru",
	svTankCount: "{n} tank",
	svOrderCount: "{n} order",
	svCancelledGroup: "Dibatalkan",
	svCreatedBy: "Dibuat oleh",
	svWorkedBy: "Dikerjakan oleh",
	svNotStarted: "Belum ada",
	svMine: "Dikerjakan oleh saya",
	svPosNeeded: "Perlu update posisi",
	svPosUpdate: "Update posisi",
	...
	svContinue: "Lanjutkan survey",
	svTomorrow: "Besok",
	svDaysAhead: "{n} hari lagi",
	svDaysAgo: "lewat {n} hari",
	svEmpty: "Tidak ada jadwal survey yang cocok.",
	svMore: "Lihat semua",
	// Detail jadwal.
	...
	svTankList: "Daftar tank",
	svReadyNote: "{n} tank siap disurvey",
	svReadyNoteHint: "Survey bisa ditutup setelah semua tank lowered.",
	svOpenTank: "Buka tank · {no}",
	...
	posReopenReasonHint: "mis. tank belum benar-benar turun",
	posReopenLoweringAsk: "Kembalikan ke lowering?",
	posReopenLoweringBody: "Status tank kembali ke Menunggu lowering. Draft EIR-Out yang sudah terbit akan dibatalkan.",
	...
	monitorYardTitle: "Posisi di yard",
	monitorYardEmpty: "Posisinya belum pernah dicatat.",
	monitorYardRecorded: "dicatat {t}",
	monitorYardOpen: "Buka Posisi Tank",
