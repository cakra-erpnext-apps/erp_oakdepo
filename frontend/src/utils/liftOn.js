...
//
// One definition for three screens (EIR, Cleaning, M&R): the badge is a vocabulary an
// operator learns once — "H-3" is three days to pickup, "Hari-H" is today, "Lewat 2 hr" is
// two days overdue — and three copies of it would eventually disagree about the colour of
// urgency, which is the one thing the badge exists to say.
//
