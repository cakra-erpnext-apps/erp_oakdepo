...
(``operations/service_menu.DEFAULT_MENU_GROUPS``), which is also where the menus added later
...
def execute():
	from container_depot.operations.service_menu import DEFAULT_MENU_GROUPS, seed_default_menus
