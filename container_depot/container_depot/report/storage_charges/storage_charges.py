...
def _columns():
	return [
		...
		{"fieldname": "gate_in", "label": "Gate In", "fieldtype": "Datetime", "width": 150},
		{"fieldname": "in_date", "label": "EIR In (Mulai Storage)", "fieldtype": "Datetime", "width": 170},
