...
# operator can see and change (see container_depot/service_menu.DEFAULT_MENU_GROUPS).
SURVEY_MENU = "Survey"
...
class SurveyOrder(Document):
    ...
    def on_submit(self):
        ...
        from container_depot.container_depot.notify import notify_survey_order_submitted
