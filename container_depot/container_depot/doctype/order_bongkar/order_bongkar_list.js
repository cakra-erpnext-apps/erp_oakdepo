...
// Order Bongkar list view — the bon for bongkar (tank masuk / unloading).
//
...
frappe.listview_settings["Order Bongkar"] = {
	...
	get_indicator(doc) {
		...
		const map = {
			...
			"Ready To Unload": [__("Siap Bongkar"), "green", "order_status,=,Ready To Unload"],
